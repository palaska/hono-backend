# Backend template (Hono + Drizzle + Zod + OpenAPI)

A starter template for building fully documented type-safe JSON APIs with Hono and Open API, ready to use with Cloudflare workers.
